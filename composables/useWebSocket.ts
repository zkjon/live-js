...
export const useWebSocket = (): UseWebSocketReturn => {
  ...
  let executionResolver: ((result: { output: string; error: string; executionTime: number }) => void) | null = null
  ...
  const executeCode = (code: string): Promise<{ output: string; error: string; executionTime: number }> => {
