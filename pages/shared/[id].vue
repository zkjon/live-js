  ...
  <div class="min-h-screen bg-gray-50">
    ...
    <div v-if="pending" class="flex items-center justify-center min-h-screen">
      <div class="text-center">
        <div
          class="animate-spin rounded-full h-12 w-12 border-b-2 border-green-600 mx-auto mb-4"></div>
    ...
    <div
      ...
      <div class="text-center max-w-md mx-4">
        ...
        <p class="text-gray-600 mb-6">
          {{
            error.statusMessage ||
            "El código que buscas no existe o ha sido eliminado."
          }}
        </p>
        <NuxtLink
          to="/"
    ...
    <div v-else-if="data" class="min-h-screen">
      ...
      <main class="max-w-7xl mx-auto p-4">
        <div
          ...
          <div class="relative">
            <pre
              class="p-4 text-sm font-mono text-gray-800 overflow-x-auto bg-white"><code>{{ data.code }}</code></pre>

            <!-- Copy button overlay -->
            <button
              @click="copyCode"
              class="absolute top-2 right-2 p-2 bg-gray-800 bg-black/75 hover:bg-black/90 text-white rounded transition-all opacity-0 hover:opacity-100 focus:opacity-100"
              title="Copiar código">
